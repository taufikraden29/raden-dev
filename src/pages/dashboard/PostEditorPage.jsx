...
const PostEditorPage = () => {
    ...
    const [showTutorial, setShowTutorial] = useState(() => {
        return localStorage.getItem('hide_editor_tutorial') !== 'true';
    });
    ...
    // Smart language suggestion based on content
    ...
    // Handle Ctrl+Shift+V for paste as code
    useEffect(() => {
    ...
    const handlePasteAsCode = async () => {
        try {
            ...
            // Fallback: show modal with empty textarea to paste manually
            setCodeToPaste('');
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                setError(`Failed to load data: ${err.message || 'Unknown error'}. Check console for details.`);
            } finally {
                setLoading(false);
            }
        };
    ...
    const insertMarkdown = (syntax, placeholder = '') => {
        ...
        // Use requestAnimationFrame for more reliable timing after React re-render
    ...
    const clearDraft = () => localStorage.removeItem(AUTOSAVE_KEY);
        ...
        <div className="post-editor-page">
            <header className="editor-header">
                <div className="header-left">
                    <button type="button" onClick={() => navigate('/dashboard/posts')} className="back-btn">
                    ...
                    <div className="tutorial-content">
                        <div className="tutorial-step">
                            ...
                            <div className="step-content">
                                <strong>Tulis Judul & Deskripsi</strong>
                                <p>Isi judul menarik dan excerpt singkat untuk SEO</p>
                            </div>
                        </div>
                        <div className="tutorial-step">
                            <div className="step-number">2</div>
                            <div className="step-content">
                                <strong>Tulis Konten dengan Markdown</strong>
                                <p>Gunakan toolbar atau ketik langsung. Klik "Markdown" untuk panduan syntax</p>
                            </div>
                        </div>
                        <div className="tutorial-step">
                            <div className="step-number">3</div>
                            <div className="step-content">
                                <strong>Paste Kode dengan Mudah</strong>
                                <p>Klik <span className="kbd">Paste Code</span> atau tekan <span className="kbd">Ctrl+Shift+V</span> untuk paste dengan syntax highlighting</p>
                            </div>
                        </div>
                        <div className="tutorial-step">
                            ...
                            <div className="step-content">
                                ...
                                <p>Gunakan Split View untuk melihat hasil. Centang "Publish" jika siap tayang</p>
                            </div>
                        </div>
                    </div>
                    <div className="tutorial-footer">
                        <span className="tutorial-hint">💡 Draft tersimpan otomatis setiap 30 detik</span>
...
Tip: Use 'Paste Code' button or Ctrl+Shift+V to paste code with syntax highlighting!"
                    ...
                    <div className="modal code-paste-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="code-paste-content">
                            ...
                            <textarea
                                ...
                                placeholder="Paste your code here (or it will be auto-filled from clipboard)..."
                                value={codeToPaste}
