...
const TutorialDetailPage = () => {
    ...
    // Check premium status when tutorial loads
    useEffect(() => {
        if (tutorial) {
            if (tutorial.is_premium) {
                const unlocked = isTutorialUnlocked(tutorial.id);
                setIsUnlocked(unlocked);
            } else {
                // Non-premium tutorials are always unlocked
                setIsUnlocked(true);
            }
        }
    }, [tutorial]);
    ...
    const handleUnlock = () => {
        setUnlockError('');
        const result = unlockTutorial(tutorial.id, unlockCode);
        if (result.success) {
            setIsUnlocked(true);
    ...
    // Show lock modal for premium tutorials
            ...
            <div className="course-container">
                    ...
                    <div className="course-content">
                        ...
                        {notesOpen && (
                            <div className="notes-panel">
                                ...
                                <textarea
                                    placeholder="Tulis catatanmu untuk langkah ini... (tersimpan otomatis)"
                                    value={currentNote}
                        ...
                        <div className="content-nav">
                            ...
                            {isLastStep ? (
                                <Link to="/tutorials" className="nav-btn next finish">
                                    <Sparkles size={20} />
                ...
                <aside className={`course-sidebar ${sidebarOpen ? 'open' : ''}`}>
                    ...
                    <div className="sidebar-meta">
                        ...
                        <span><Clock size={14} /> {tutorial.estimatedTime || '10 min'}</span>
                    </div>
                    ...
                    <div className="shortcuts-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="shortcuts-list">
                            <div className="shortcut">
                                <kbd>→</kbd> atau <kbd>L</kbd>
                                <span>Langkah selanjutnya</span>
                            </div>
                            <div className="shortcut">
                                <kbd>←</kbd> atau <kbd>H</kbd>
                                <span>Langkah sebelumnya</span>
                            </div>
                            <div className="shortcut">
                                <kbd>Space</kbd>
                                <span>Tandai selesai/belum</span>
                            </div>
                            <div className="shortcut">
                                <kbd>N</kbd>
                                <span>Buka/tutup catatan</span>
                            </div>
                            <div className="shortcut">
                                <kbd>?</kbd>
