...
const TutorialEditorPage = () => {
    ...
    const addStep = () => {
        setFormData(prev => ({
            ...prev,
            steps: [...prev.steps, { title: '', content: '', youtube_url: '' }]
        }));
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.title.trim()) {
            setError('Judul tutorial wajib diisi');
            return;
        }
        ...
        <div className="tutorial-editor-page">
            <header className="editor-header">
                <div className="header-left">
                    <button onClick={() => navigate('/dashboard/tutorials')} className="back-btn">
                        <ArrowLeft size={18} />
                    </button>
            ...
            <div className="editor-layout">
                ...
                <div className="info-panel">
                    ...
                    <div className="premium-section">
                        <div className="form-group">
                            <label className="toggle-label premium-toggle">
                                <input
                                    type="checkbox"
                                    name="is_premium"
                            ...
                            <div className="unlock-code-section">
                                ...
                                <div className="code-input-group">
                                    <input
                                        ...
                                        readOnly
                                        placeholder="Generate kode..."
                                    />
                                    <button
                                        type="button"
                                        className="btn btn-secondary code-btn"
                                        onClick={() => setFormData(prev => ({ ...prev, unlock_code: generateUnlockCode() }))}
                                    ...
                                    {formData.unlockCode && (
                                        <button
                                            ...
                                            className="btn btn-secondary code-btn"
                                            onClick={() => {
                                                navigator.clipboard.writeText(formData.unlockCode);
                                                alert('Kode disalin!');
                                            }}
                                            title="Copy kode"
                                        >
                ...
                <div className="steps-panel">
                    <div className="steps-sidebar">
                        <div className="steps-header">
                            <h3>Langkah ({formData.steps.length})</h3>
                            <button className="btn-icon-sm" onClick={addStep} title="Tambah langkah">
                                <Plus size={16} />
                            </button>
                        </div>
                            ...
                            <>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        value={currentStep.youtube_url || ''}
                                        onChange={(e) => handleStepChange(activeStep, 'youtube_url', e.target.value)}
                                    />
                                    {currentYouTubeId && (
                                        <div className="youtube-preview-small">
                                            <img
                                                src={`https://img.youtube.com/vi/${currentYouTubeId}/mqdefault.jpg`}
                                                alt="Video thumbnail"
                                            />
                                            <span className="preview-badge">✓ Video terdeteksi</span>
                                        </div>
                                    )}
                                </div>
                                <div className="form-group flex-1">
                                    ...
                                    <textarea
                                        className="form-textarea step-content-input"
                                        placeholder="Tulis instruksi dengan Markdown..."
                                        value={currentStep.content}
                                        onChange={(e) => handleStepChange(activeStep, 'content', e.target.value)}
                                    />
                                </div>
